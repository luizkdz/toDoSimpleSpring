package com.luiz.todosimple.exceptions;
...
import com.luiz.todosimple.services.DataBindingViolationException;
import com.luiz.todosimple.services.ObjectNotFoundException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
        ...
        ErrorResponse errorResponse = new ErrorResponse(status, "Falha na autenticação");
